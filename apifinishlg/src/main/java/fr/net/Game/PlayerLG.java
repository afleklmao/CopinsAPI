...
public class PlayerLG implements Listener, PlayerWW {
    ...
    private final transient WereWolfAPI game;
    ...
    public PlayerLG (GetWereWolfAPI main, WereWolfAPI game, Player player) {
        this.spawn = player.getWorld().getSpawnLocation();
        this.playerUUID=player.getUniqueId();
        this.game=game;
        this.role=new NewWereWolf(main,game,this.playerUUID);
